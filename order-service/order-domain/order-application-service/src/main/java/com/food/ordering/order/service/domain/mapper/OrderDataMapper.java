...
public class OrderDataMapper {
    ...
    public Order createOrderCommandToOrder(CreateOrderCommand createOrderCommand){
        return Order.builder()
                ...
                .items(orderItemsOrderItemEntities(createOrderCommand.getItems()))
                .build();
    }

    private List<OrderItem> orderItemsOrderItemEntities(List<com.food.ordering.order.service.domain.dto.create.OrderItem> orderItems) {
        return orderItems.stream()
                .map(orderItem ->
                        orderItem.builder()
                )           .product(new Product(new Prod))
    }
